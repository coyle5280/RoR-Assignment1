...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { name: @professor.name, office: @professor.office, student_id: @professor.student_id }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { name: @professor.name, office: @professor.office, student_id: @professor.student_id }
    assert_redirected_to professor_path(assigns(:professor))
  end
